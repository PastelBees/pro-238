...
#flaskgroup creates commands for managing this app
cli = FlaskGroup(create_app=create_app)

#putting user data into a list
user_json = [
	{
		"name": "John Doe",
...
#putting product data into a list
product_json = [
	{
...
#resets the data base by deleting the entire db and making a new one
def recreate_db():
	db.drop_all()
	db.create_all()
	db.session.commit()

#resets the data base by updating(?) it
def seeder():
	#getting user info
